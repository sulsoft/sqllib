...
/*
 * Classe para encapsular os dados de uma conexÆo. Por padrÆo a conexÆo relacionada
 */
...
/*
 * Puxa os dados da conexÆo atual e carrega para a nossa instancia do objeto 
 */
METHOD New( nHandle ) ;
   CLASS TSL_CONNECTION
